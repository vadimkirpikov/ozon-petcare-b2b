...
const revData = [
  { name: 'Янв', Услуги: 40000, Аффилиаты: 2400 },
  { name: 'Фев', Услуги: 30000, Аффилиаты: 1398 },
  { name: 'Мар', Услуги: 20000, Аффилиаты: 9800 },
  { name: 'Апр', Услуги: 27800, Аффилиаты: 3908 },
  { name: 'Май', Услуги: 18900, Аффилиаты: 4800 },
  { name: 'Июн', Услуги: 23900, Аффилиаты: 3800 },
];

const pieData = [
  { name: 'Услуги (Приемы)', value: 85 },
  { name: 'Продажи товаров Ozon', value: 15 },
];
const COLORS = ['#2563eb', '#ec4899'];

const transactions = [
  { id: 1, type: 'withdraw', desc: 'Еженедельный транш выплат', amount: -150000, date: '12.05.2026', status: 'Выполнено' },
  { id: 2, type: 'income', desc: 'Услуги по ЕМИАС', amount: 8400, date: '11.05.2026', status: 'Заморожено' },
  { id: 3, type: 'affiliate', desc: 'Ozon партнерка (5 заказов)', amount: 1450, date: '10.05.2026', status: 'Выполнено' },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="col-span-1 md:col-span-2 bg-gradient-to-br from-gray-900 to-gray-800 border-0 flex flex-col justify-between p-6">
           ...
           <div className="mt-8 flex justify-between items-end">
             <div>
               <p className="text-gray-400 text-sm font-medium mb-1">Доступно к выводу</p>
               <h3 className="text-4xl font-bold text-white tracking-tight">142 500,00 ₽</h3>
             </div>
             <button className="bg-brand-500 hover:bg-brand-400 text-white px-6 py-2.5 rounded-xl font-bold transition-colors">
               Вывести средства
             </button>
           </div>
        </Card>
        ...
        <Card className="flex flex-col justify-between p-6">
          <div className="flex items-center justify-between mb-4">
            <h4 className="font-semibold text-gray-700">Доп. доход с продаж</h4>
            <Sparkles className="text-ozon-500" size={20} />
          </div>
          <div>
          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar dataKey="Услуги" stackId="a" fill="#2563eb" radius={[0, 0, 4, 4]} barSize={32} />
                <Bar dataKey="Аффилиаты" stackId="a" fill="#ec4899" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
          ...
          <tbody className="divide-y divide-gray-100">
             {transactions.map(t => (
               <tr key={t.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className={cn("w-8 h-8 rounded-full flex items-center justify-center shrink-0", 
                        ...
                        t.type === 'affiliate' ? 'bg-ozon-50 text-ozon-600' : 'bg-green-50 text-green-600'
                      )}>
                        {t.type === 'withdraw' ? <ArrowDownRight size={16} /> :
                         t.type === 'affiliate' ? <Sparkles size={14} /> : <ArrowUpRight size={16} />}
                      </div>
                  ...
                  <td className={cn("px-6 py-4 text-right font-bold", t.amount > 0 ? "text-green-600" : "text-gray-900")}>
