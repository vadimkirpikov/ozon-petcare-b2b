...
const transactions = [
    {
        id: 1,
        type: 'withdraw',
        desc: 'Еженедельный транш выплат на р/с',
        amount: -150000,
        date: '12.05.2026',
        status: 'Выполнено'
    },
    {id: 2, type: 'income', desc: 'Оплата услуг (Ozon Pay)', amount: 8400, date: '11.05.2026', status: 'Заморожено'},
    {
        id: 3,
        type: 'telemed',
        desc: 'Телемед: Консультация 20 мин',
        amount: 1450,
        date: '10.05.2026',
        status: 'Выполнено'
    },
    ...
    return (
        <div className="flex flex-col gap-6 max-w-7xl mx-auto pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card
                    className="col-span-1 md:col-span-2 bg-gradient-to-br from-gray-900 to-gray-800 border-0 flex flex-col justify-between p-6">
                    ...
                    <div className="mt-8 flex justify-between items-end">
                        ...
                        <button
                            className="bg-brand-500 hover:bg-brand-400 text-white px-6 py-2.5 rounded-xl font-bold transition-colors">
                            Вывести средства
                        </button>
                    </div>
                </Card>
                    ...
                    <div className="h-72 w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={revData} margin={{top: 0, right: 0, left: -20, bottom: 0}}>
                                ...
                                <Tooltip cursor={{fill: '#f9fafb'}} contentStyle={{
                                    borderRadius: '12px',
                                    border: 'none',
                                    boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)'
                                }}/>
                                <Bar dataKey="Офлайн услуги" stackId="a" fill="#2563eb" radius={[0, 0, 4, 4]}
                                     barSize={32}/>
                ...
                <table className="w-full text-left">
                    ...
                    {transactions.map(t => (
                        <tr key={t.id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-6 py-4">
                                {t.status === 'Выполнено' ? <Badge variant="success">Выполнено</Badge> :
                                    <Badge variant="warning">Заморожено</Badge>}
                            </td>
